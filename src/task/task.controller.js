...
const assignUserToTask = async (req, res) => {
    try {
        ...
        console.log("Assigning user to task:", { taskId, body: req.body });
        ...
        return res.status(200).json({ message: "User assigned to task successfully." });
    } catch (error) {
        return res.status(500).json({ message: "Unable to assign user to task.", error: error.message });
    }
};
...
const getTaskAssignees = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Unable to fetch task assignees.", error: error.message });
    }
};
